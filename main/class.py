...
#советую сначало объявлять a=User("name") и за тем уже n=Achievement(a.getname()) (так правильнее, не придется в ручную отслеживать имя пользователя, так же не будет конфликта с неинициализированным пользователем)
